...
app.use(`${apiv1}/terms`, require("./routes/terms_empty"));
app.use(`${apiv1}/about`, require("./routes/about_empty"));
app.use(`${apiv1}/logout`, require("./routes/logout"));
app.use(`${apiv1}/file_neeraj`, require("./routes/file-upload_neeaj"));
